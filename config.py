...
class Config:
    ...
    class Bot:
        ...
        FILEBROWSER_API_URL = os.getenv("FILEBROWSER_API_URL", "http://93.127.136.209:8082/api")
        FILEBROWSER_ADMIN_USER = os.getenv("FILEBROWSER_ADMIN_USER", "admin")
        FILEBROWSER_ADMIN_PASS = os.getenv("FILEBROWSER_ADMIN_PASS", "AdminDemo1234")
        FILEBROWSER_PUBLIC_URL = os.getenv("FILEBROWSER_PUBLIC_URL", "http://93.127.136.209:8082)
